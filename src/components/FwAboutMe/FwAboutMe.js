        ...
        return (
            <div className="FwAboutMe" name="about">
                ...
                <div className="FwAboutMe__text">
                    <h1>About Me</h1>
                    <p>
                        I am 18 years old, living in Germany and currently studying business and computer science in Düsseldorf. Coding is a hobby for me, and I would like to turn this hobby into a career.
